...
server.ready.then(() => {
  ...
  //    1. add an entry in wwwroot/test/e2e/nightwatch.conf.json under "test_settings"
  ...
  if (opts.indexOf('--config') === -1) {
    opts = opts.concat(['--config', 'wwwroot/test/e2e/nightwatch.conf.js']){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
  }
